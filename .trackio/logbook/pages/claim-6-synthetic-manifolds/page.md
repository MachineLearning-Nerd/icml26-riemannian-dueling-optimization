# Claim 6 — Synthetic manifolds


---
<!-- trackio-cell
{"type": "markdown", "id": "cell_e32e765950bb", "created_at": "2026-07-29T12:55:42+00:00", "title": "Evidence"}
-->
Full source Rayleigh dimensions d=100,150 and 50,000 iterations: gap decreases to 8.0e-7 and 1.7e-5, with unit-norm feasibility. Source-scale diagonal SPD Karcher constructions n=5,10,m=50 have gradient norm below 2e-16. SO(2) correction gives residual 9.2e-6 versus 1.78 in the wrong direction.


---
<!-- trackio-cell
{"type": "code", "id": "cell_4cd6fbcc0064", "created_at": "2026-07-29T12:55:58+00:00", "title": "Full 50k verifier", "command": ["env", "OPENBLAS_NUM_THREADS=1", ".venv/bin/python", "repro/src/verify.py"], "exit_code": 0, "duration_s": 7.405}
-->
````bash
$ env OPENBLAS_NUM_THREADS=1 .venv/bin/python repro/src/verify.py
````
...
````output
{"all_target_claims_passed": true, "verified_claim_count": 5}
